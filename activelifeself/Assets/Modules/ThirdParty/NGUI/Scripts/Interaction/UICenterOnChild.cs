...
public class UICenterOnChild : MonoBehaviour
{
	...
	{ 
		...
		// Modification by Theo Christensen 10//24/2014
		private set
		{
			mCenteredObject = value;
			if (null != OnCenteredObjectChanged)
				OnCenteredObjectChanged(mCenteredObject);
		}
	}
	
	// Modification by Theo Christensen 10//24/2014
	/// <summary>
	/// Callback for when the centered object changes.
	/// </summary>
	public delegate void OnCenteredObjectChangedDelegate(GameObject centeredObject);
	// Modification by Theo Christensen 10//24/2014
	public OnCenteredObjectChangedDelegate OnCenteredObjectChanged;
	...
	/// <summary
	/// Determine the transform to center on. Added by Theo Christensen 11/12/14.
	/// </summary>
	public Transform DetermineCenterTarget()
	{
		...
		if (mScrollView.panel == null) return null;
	...
	public void Recenter ()
	{
		...
		Transform closest = DetermineCenterTarget();
		if (null != closest)
